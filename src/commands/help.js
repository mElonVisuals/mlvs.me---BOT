...
module.exports = {
    ...
    async execute(interaction) {
        try {
            // --- FIX: Check if interaction is already handled and use proper flags ---
            ...
            // --- FIX: Use editReply() after deferring the interaction with proper error handling ---
            ...
            if (!interaction.replied && !interaction.deferred) {
                ...
                try {
                    ...
                    console.error('Failed to edit deferred response:', editError);
                }
            }
        }
    },
